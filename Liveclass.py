...
data = {
    ...
    "is_free": 0,
    "payable_type": 1,
    "topic": dynamic_title,            # Use dynamic date in topic
    "app_title": dynamic_title,         # Use dynamic date in app title
    "app_sub_title": dynamic_title,     # Use dynamic date in app subtitle
    "tags": [dynamic_title],
    "guru_org_id": 304,
    "meeting_type": 1,
...
#print("Sucessfully Created Live Class", if response.json.id == 200 : ),
